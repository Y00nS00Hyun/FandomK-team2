...
const Footer = styled.footer`
  position: relative;
  z-index: 8;
  margin-top: ${({ $footerHeight }) => ($footerHeight ? $footerHeight : 80)}px;
...
const Inner = styled.section`
  ...
  height: ${({ $footerHeight }) => ($footerHeight ? $footerHeight : 80)}px;
...
function RootFooter({ footerHeight }) {
  /**
   * @todo 푸터 콘텐츠 기획 필요
   */
  return (
    <Footer $footerHeight={footerHeight}>
      <Inner className="inner" $footerHeight={footerHeight}>
        <Section>
          <BasicText>
            <Copyright>Copyright by codeit; sprinter</Copyright>
          </BasicText>
        </Section>

        <Section>
          <BasicText>front-end 7기 part2. team2.</BasicText>
        </Section>

        <Section>
          <Link to={"https://react.dev/"} target="_blank" draggable="false">
            <SkillIcon>
              <SVG width="24" height="24" viewBox="-10.5 -9.45 21 18.9" fill="none" xmlns="http://www.w3.org/2000/svg" draggable="false">
          ...
          <Link to={"https://reactrouter.com/en/main"} target="_blank" draggable="false">
            <SkillIcon>
              <SVG width="50" height="24" viewBox="0 0 94 61" xmlns="http://www.w3.org/2000/svg" draggable="false">
          ...
          <Link to={"https://styled-components.com/"} target="_blank" draggable="false">
            <SkillIcon>
              <Image src={"https://styled-components.com/nav-logo.png"} height="24" draggable="false" />
            </SkillIcon>
          </Link>
        </Section>
      </Inner>
