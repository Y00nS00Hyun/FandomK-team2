  ...
  return (
    <>
      <Article $mode={mode}>
        ...
        <Modal show={visibleModal} modalOpen={true} title={"크레딧 충전하기"} onClose={() => setVisibleModal(false)} icon={"credit"} buttonAction={handleClick} buttonName={"충전하기"} disabled={creditValue === 0}>
